...
object ShoppingListTestTags {
    ...
    const val EMPTY_PENDING_ICON = "empty_pending_icon"
    const val EMPTY_PENDING_TEXT = "empty_pending_text"
    const val EMPTY_PURCHASED_ICON = "empty_purchased_icon"
    const val EMPTY_PURCHASED_TEXT = "empty_purchased_text"
    const val DELETE_ITEM_DIALOG = "delete_item_dialog"
    const val SUGGESTION_LIST = "suggestion_list"
    const val BRAND_ICON = "brand_icon"
